...
@method('PUT')
<div class="mb-4">
<label class="block mb-2 font-medium text-gray-
700">Judul Event</label>
...
value="{{ $event->date }}" class="w-full border border-gray-
300 p-2.5 rounded" required>
</div>
