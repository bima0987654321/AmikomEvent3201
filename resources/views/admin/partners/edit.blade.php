...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm">Ubah informasi partner</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
        ...
        <form action="{{ route('admin.partners.update', $partner->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 flex justify-center">
                    <img id="logoPreview" src="{{ $partner->logo_url }}" alt="Logo Preview" class="h-32 w-32 object-contain">
                </div>
            </div>
